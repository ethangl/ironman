      ...
      <div className="text-center mb-10">
        ...
        {sample && sample.count > 0 && (
          <p className="mt-4 text-muted-foreground">
            ...
            <span className="text-foreground font-bold">{sample.count}</span>{" "}
        ...
        <Link
          href={`/?lockIn=${trackId}`}
          className="mt-8 inline-block rounded-xl bg-red-600 px-8 py-3 text-lg font-bold text-foreground hover:bg-red-500 transition"
        >
          Accept Challenge
        </Link>
      </div>
